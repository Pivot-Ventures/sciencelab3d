...
export function FloatingControlPanel({
  ...
  return (
    ...
    >
      <div className="w-full bg-linear-to-br from-white to-[#e3f3ea]/80 backdrop-blur-xl border border-[#e2ddd0] rounded-xl shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between sticky top-0 bg-linear-to-r from-[#2f6b4f] to-[#1f4d43] py-2 px-3 sm:px-6 -mx-3 border-b border-[#e2ddd0] shrink-0">
